...
aristocratic_cards = [{'name': 'e3s3d3', 'requirements': {'emerald': 3, 'sapphire': 3, 'diamond': 3}, 'points': 3},
                      {'name': 'o4r4', 'requirements': {'onyx': 4, 'ruby': 4}, 'points': 3},
                      {'name': 'o3s3d3', 'requirements': {'onyx': 3, 'sapphire': 3, 'diamond': 3}, 'points': 3},
                      {'name': 'o3r3e3', 'requirements': {'onyx': 3, 'ruby': 3, 'emerald': 3}, 'points': 3},
                      {'name': 'o4d4', 'requirements': {'onyx': 4, 'diamond': 4}, 'points': 3},
                      {'name': 'e3s3r3', 'requirements': {'emerald': 3, 'sapphire': 3, 'ruby': 3}, 'points': 3},
                      {'name': 'r4e4', 'requirements': {'ruby': 4, 'emerald': 4}, 'points': 3},
                      {'name': 's4d4', 'requirements': {'sapphire': 4, 'diamond': 4}, 'points': 3},
                      {'name': 'o3r3d3', 'requirements': {'onyx': 3, 'ruby': 3, 'diamond': 3}, 'points': 3},
                      {'name': 's4e4', 'requirements': {'sapphire': 4, 'emerald': 4}, 'points': 3}]

# Lvl 3 cards ===============================================================================

# 3 pts, 4 stones
cards_3_3_4 = [
    {'name': 'sapphire_3_3_4', 'pts': 3, 'requirement': {'diamond': 3, 'emerald': 3, 'ruby': 3, 'onyx': 5},
     'img': '1cs.png'},
    {'name': 'ruby_3_3_4', 'pts': 3, 'requirement': {'diamond': 3, 'sapphire': 5, 'emerald': 3, 'onyx': 3},
     'img': '2cs.png'},
    {'name': 'diamond_3_3_4', 'pts': 3, 'requirement': {'sapphire': 3, 'emerald': 3, 'ruby': 5, 'onyx': 3},
     'img': '3cs.png'},
    {'name': 'onyx_3_3_4', 'pts': 3, 'requirement': {'diamond': 3, 'sapphire': 3, 'emerald': 5, 'ruby': 3},
     'img': '4cs.png'},
    {'name': 'emerald_3_3_4', 'pts': 3, 'requirement': {'diamond': 5, 'sapphire': 3, 'ruby': 3, 'onyx': 3},
     'img': '5cs.png'},
]
...
cards_1_4_0_v1 = {'sapphire':
                  ...
                  'ruby':
                      {'pts': 0, 'requirement': {'diamond': 1, 'sapphire': 1, 'emerald': 1, 'onyx': 1},
                       'img': '82cs.png'},
                  'diamond':
                      {'pts': 0, 'requirement': {'sapphire': 1, 'emerald': 1, 'ruby': 1, 'onyx': 1}, 'img': '83cs.png'},
                  'onyx':
                      {'pts': 0, 'requirement': {'diamond': 1, 'sapphire': 1, 'emerald': 1, 'ruby': 1},
                       'img': '84cs.png'},
                  'emerald':
...
cards_1_4_0_v2 = {'sapphire':
                  ...
                  'ruby':
                      {'pts': 0, 'requirement': {'diamond': 2, 'sapphire': 1, 'emerald': 1, 'onyx': 1},
                       'img': '87cs.png'},
                  'diamond':
                      {'pts': 0, 'requirement': {'sapphire': 1, 'emerald': 2, 'ruby': 1, 'onyx': 1}, 'img': '88cs.png'},
                  'onyx':
                      {'pts': 0, 'requirement': {'diamond': 1, 'sapphire': 2, 'emerald': 1, 'ruby': 1},
                       'img': '89cs.png'},
                  'emerald':
